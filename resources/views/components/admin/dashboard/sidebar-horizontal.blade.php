                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                @foreach ($link['children'] as $child_link)
                                    <li class="sidebar-item">
                                        <a href="{{ isset($child_link['url']) ? $child_link['url'] : route($child_link['route']) }}"
                                            class="sidebar-link {{ request()->routeIs($child_link['route']) ? 'active' : '' }}">
                                            @isset($child_link['icon'])
                                            @if (str_contains($child_link['icon'], 'ti ti-'))
...
<li class="sidebar-item">
    ...
    <ul aria-expanded="false" class="collapse first-level">
        ...
        <li class="sidebar-item">
            <a href="https://bootstrapdemos.adminmart.com/matdash/dist/default-sidebar/apps-kanban.html"
                class="sidebar-link">
...
<!-- =================== -->
<li class="sidebar-item">
    <a class="sidebar-link two-column has-arrow" href="index.html#" aria-expanded="false">
        <span class="rounded-3">
...
<li class="sidebar-item">
    ...
    <ul aria-expanded="false" class="collapse first-level">
        ...
        <li class="sidebar-item">
            <a href="index.html#" class="sidebar-link has-arrow">
                <i class="ti ti-circle"></i>
