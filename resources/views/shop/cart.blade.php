...
<div class="block-header block-header--has-breadcrumb block-header--has-title">
 ...
 class="image__tag" src="images/products/product-4-160x160.jpg"
                                        ...
                                        <td class="cart-table__column cart-table__column--product">
                                            <a href="" class="cart-table__product-name">Glossy Gray 19" Aluminium
                                                Wheel AR-19</a>
 ...
 class="image__tag" src="images/products/product-2-160x160.jpg"
                                        ...
                                        <td class="cart-table__column cart-table__column--product">
                                            <a href="" class="cart-table__product-name">Brandix Brake Kit
                                                BDX-750Z370-S</a>
                                        </td>
                                        <td class="cart-table__column cart-table__column--price" data-title="Price">
                                            $849.00</td>
 ...
 class="image__tag" src="images/products/product-5-160x160.jpg"
                                        ...
                                        <td class="cart-table__column cart-table__column--product">
                                            <a href="" class="cart-table__product-name">Twin Exhaust Pipe From
                                                Brandix Z54</a>
                                            <ul class="cart-table__options">
