         ...
         <nav class="navbar navbar-expand-lg p-0">
             <ul class="navbar-nav">
                 ...
                 <li class="nav-item d-none d-lg-flex dropdown nav-icon-hover-bg rounded-circle">
                     <div class="hover-dd">
                         <a class="nav-link" id="drop2" href="index.html#" aria-haspopup="true"
                             aria-expanded="false">
                         ...
                         <div class="dropdown-menu dropdown-menu-nav dropdown-menu-animate-up py-0 overflow-hidden"
                             ...
                             <div class="position-relative">
                                 <div class="row">
                                     ...
                                     <div class="col-4">
                                         <img src="{{ asset('images/admin/backgrounds/mega-dd-bg.jpg') }}"
                                             alt="mega-dd" class="img-fluid mega-dd-bg" loading="lazy">
                                     </div>
                                 </div>
                             </div>
                         </div>
                                 ...
                                 <div class="message-body" data-simplebar>
                                     <a href="javascript:void(0)"
                                         ...
                                         <div class="w-75 d-inline-block ">
                                             ...
                                             <span class="d-block text-truncate text-truncate fs-11">Just see the my
                                                 new admin!</span>
                                         </div>
                                     </a>
                                     <a href="javascript:void(0)"
                                         ...
                                         <div class="w-75 d-inline-block ">
                                             ...
                                             <span class="d-block text-truncate text-truncate fs-11">Just a reminder
                                                 that you have event</span>
                                         </div>
                                     </a>
                                     <a href="javascript:void(0)"
                                         class="py-6 px-7 d-flex align-items-center dropdown-item gap-3">
                                         ...
                                         <div class="w-75 d-inline-block ">
                                             ...
                                             <span class="d-block text-truncate text-truncate fs-11">You can customize
