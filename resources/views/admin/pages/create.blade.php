                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error("title.$locale") is-invalid @enderror"
                                        name="title[{{ $locale }}]" value="{{ old("title.$locale") }}"
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea class="form-control ckeditor @error("content.$locale") is-invalid @enderror"
                                        name="content[{{ $locale }}]" rows="5" placeholder="Write content...">{{ old("content.$locale") }}</textarea>
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        name="meta[{{ $locale }}][title]" value="{{ old("meta.$locale.title") }}">
                                ...
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old("meta.$locale.description") }}">
